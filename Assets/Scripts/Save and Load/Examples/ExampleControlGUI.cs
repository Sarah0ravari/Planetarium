    ...
    void OnGUI() {
        ...
        if (Open) {
            ...
            if (sceneCount > 1) {
                ...
                GUI.Box(new Rect(10, 10, 470, height), "Save and Load Solar System");
                if(GUI.Button(new Rect(490, 10, 50, 30), "Close")) {
                    Open = false;
                }
            } else {
                GUI.Box(new Rect(10, 10, 330, 160), "Save and Load Solar System");
            ...
            /* This is for if we want to put a menu button in the Save GUI - repetitive
